...
- Uses clear **section headers** (`Run`, `Output`)
- Code command is **copyable**
- Output is **scannable**
- Matches how most GitHub READMEs are structured

No extra explanation needed — the user immediately knows:
...
If you want it slightly more human (still minimal):
